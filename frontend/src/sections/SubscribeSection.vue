...
<template>
    ...
    <div id="subscribe" class="bg-steel-blue mt-10">
...
<!--                <h4 class="text-sm tracking-widest uppercase text-center text-white font-theme-heading">35,000+ Already Joined</h4>-->
                <h2 class="text-3xl md:text-4xl font-medium text-center text-white mt-9 mb-10 font-theme-heading">Stay up-to-date with what we're doing</h2>
                    ...
                    <div class="relative flex flex-col items-center lg:flex-row justify-center lg:space-x-3">
                        <div class="relative w-full lg:mb-0 font-theme-content">
                            ...
                            <div v-show="emailError">
                                ...
                                <div class="absolute w-full text-xs italic px-2 py-1 bg-theme-secondary text-white rounded">Whoops, make sure it's an email</div>
                            </div>
                        </div>
